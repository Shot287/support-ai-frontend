...
function TimeBoxingDay({
  ...
  const TOP_OFFSET = 8;          // ← 共通の上オフセット（ラベル/ライン/ブロックで共有）
  const gridHeight = minutesPerDay * pxPerMin + TOP_OFFSET;
        ...
        <div className="relative" style={{ height: gridHeight }}>
          {Array.from({ length: 25 }).map((_, i) => (
            <div
              ...
              style={{ top: TOP_OFFSET + i * 60 * pxPerMin }}
            >
              {/* ずれ要因だった -translate-y-2 は撤去、line-height固定で安定 */}
