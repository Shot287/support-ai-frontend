      ...
      {isEditing && (
        <div className="animate-in fade-in slide-in-from-top-1 duration-200">
          <textarea
            ...
            rows={5}
            className="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm font-mono focus:ring-2 focus:ring-blue-500 outline-none"
