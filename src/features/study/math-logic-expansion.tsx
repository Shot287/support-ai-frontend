...
// 【重要】remark-gfmの読み込みエラーを回避するための記述
...
function normalizeMathText(raw: string): string {
  ...
  // 2) LaTeX文書構造コマンドを Markdown に簡易変換
  // \section*{タイトル} -> ## タイトル
  text = text.replace(/\\section\*?\{(.*?)\}/g, "\n## $1\n");
  // \subsection*{タイトル} -> ### タイトル
...
// JSXスプレッドエラーを防ぐため、propsを明示的に定義したコンポーネントにします
